...
import { FaGraduationCap, FaMapMarkerAlt, FaDollarSign } from "react-icons/fa";
import { IoEyeSharp } from "react-icons/io5";

// Type definition (for clarity, useful if using TypeScript)
// type ScholarshipCardProps = {
//   universityImage: string;
//   universityName: string;
//   category: string;
//   location: string;
//   applicationFee: string; // e.g., "$50" or "Free"
//   onViewDetails: () => void;
// };
...
const ScholarshipCard = ({
  ...
  // Logic to determine the fee badge color
  const isFeeFree = applicationFee.toLowerCase() === "free";
  const badgeColor = isFeeFree ? "badge-success" : "badge-warning"; // daisyUI colors

  return (
    // daisyUI card component: fixed width, elevation, and hover effect
